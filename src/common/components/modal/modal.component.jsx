  ...
  return (
    <Dialog open={show} onClose={onClose} className="custom_modal_design">
      <div className="my-scroll min-w-[429px] overflow-y-auto">
        <div className="flex items-center justify-between bg-[#E3ECF4] px-4 py-[14px] ">
          <DialogTitle className="bg-skyblue rounded-tl-[20px] rounded-tr-[20px] px-0 py-0 font-dm text-xl font-bold leading-8 text-text-dark-gray">
            {title}
          </DialogTitle>
        ...
        <DialogContent className="px-4 !pt-7 pb-6">{children}</DialogContent>
      </div>
    </Dialog>
  );
}
