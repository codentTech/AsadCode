...
import useOverview from "@/components/invoices/view/components/overview/use-overview.hook";
...
export default function InvoiceAddData({ rowData, id, action, allData }) {
  const {
    open,
    handleOpenModal,
    handleCloseModal,
        ...
        <tr>
          <td>
            ...
            >
              ...
              <FileUpload rowData={rowData} moduleName={DOCUMENT.INVOICE} />
              ...
              >
                ...
                <div className="primary-scroll max-h-[100px] overflow-y-auto ">
                  ...
                  <History
                    ...
                    moduleName={capitalizeFirstLetter(DOCUMENT.INVOICE)}
