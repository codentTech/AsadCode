...
export default function OfferAddData({ rowData, id, action, allData }) {
  const {
    open,
    handleOpenModal,
    handleCloseModal,
          ...
          <td>
            <div
              className={`jut mx-6 my-2 grid h-[168px] w-full ${
                DOCUMENT_LOWER_CASE_STATUS(rowData && rowData?.status) ===
                "rejected"
                  ? "gap-4 grid-cols-4"
                  : "gap-4 grid-cols-3 "
            ...
            >
              ...
              <FileUpload rowData={rowData} moduleName={DOCUMENT.OFFER} />
              ...
              >
                ...
                <div className="primary-scroll max-h-[100px] overflow-y-auto ">
                  ...
                  <History
                    ...
                    moduleName={capitalizeFirstLetter(DOCUMENT.OFFER)}
