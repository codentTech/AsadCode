const PremiumSidebar = () => {
  return (
    <div className="h-full max-h-[50rem] bg-gray-100 p-5 rounded-2xl max-w-sm shadow-xl">
      {/* Trending Topics */}
      <div className="mb-8">
        <h3 className="text-base font-semibold text-gray-900 mb-3 pl-2">
          🔥 Trending Topics
        </h3>
        <div className="flex flex-col gap-4 bg-white p-4 rounded-xl shadow-md">
          <div className="border-b pb-2 last:border-b-0">
            <p className="text-sm text-gray-900 font-medium">
              <strong>Jane Williams:</strong> Brands nowadays want a full-scale
              campaign for the price of a latte.
            </p>
            <small className="text-xs text-gray-500">
              13,447 Likes • 157 Comments • 98 Shares
            </small>
          </div>
          <div className="border-b pb-2 last:border-b-0">
            <p className="text-sm text-gray-900 font-medium">
              <strong>Paul Clarke:</strong> Marketing through cable TV is a
              dying industry, prove me wrong.
            </p>
            <small className="text-xs text-gray-500">
              987 Likes • 94 Comments • 48 Shares
            </small>
          </div>
        </div>
      </div>
