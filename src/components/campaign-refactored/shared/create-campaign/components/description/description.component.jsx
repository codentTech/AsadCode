  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-col items-stretch gap-4 sm:flex-row sm:items-start">
        ...
        {imagePreview && (
          <div className="flex shrink-0 justify-center pt-0 sm:justify-end sm:pt-7">
            <img
              src={imagePreview}
              alt="Campaign"
              className="h-36 w-full max-w-[200px] rounded-xl border-2 border-gray-200 object-cover shadow-sm sm:h-32 sm:w-32 sm:max-w-none"
            />
          </div>
        )}
      </div>
