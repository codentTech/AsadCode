...
function Preview({ campaignData, handleChange }) {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-4 text-gray-900">
      <section className="rounded-lg border border-gray-200 bg-white p-3 shadow-sm sm:p-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0 flex-1 space-y-3">
            <h1 className="break-words text-base font-bold uppercase leading-snug text-indigo-900 sm:text-lg md:text-xl">
              {title}
            </h1>
      ...
      <section className="grid gap-4 lg:grid-cols-[minmax(0,1.8fr)_minmax(0,1fr)] lg:items-start">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <div className="mt-3 space-y-3 text-sm text-gray-700">
          <label htmlFor="terms" className="flex cursor-pointer items-start gap-3 sm:items-center">
            <input
              type="checkbox"
              id="terms"
              name="termsAgreed"
