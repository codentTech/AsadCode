...
const BrandTimelineSteps = ({ campaignId, creatorId, onPipelineUpdated, onWorkflowComplete }) => {
  const {
    timelineSteps,
    timelineLoading,
    approveLoading,
  ...
  } = useBrandTimeline(campaignId, creatorId, onPipelineUpdated, onWorkflowComplete);
