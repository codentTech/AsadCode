  ...
  const renderNoCreatorFound = () => (
    <div className="px-2 py-12 sm:py-16">
      <NotFound
        ...
        description="Select a creator from the list to view their completed deliverables."
      />
    </div>
  );

  const renderCreatorProfile = () => (
    <div className="sticky top-0 z-10 flex flex-col items-center gap-1 border-b border-gray-100 bg-white/95 px-3 pb-3 pt-3 backdrop-blur-sm sm:pb-4">
