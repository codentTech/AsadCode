  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h3 className="text-sm font-semibold text-gray-900">Campaign Progress</h3>
      ...
      <div className="space-y-3">
        {timelineSteps.map((step) => (
          <div
            key={step.id}
            className="relative rounded-lg border border-gray-200 bg-white p-3 transition-all duration-200 sm:p-4"
          >
            {/* Step Header */}
            ...
            {/* Timestamps and Info */}
            <div className="mb-3 flex items-center gap-3 text-[10px] text-gray-500 sm:gap-4 sm:text-xs">
