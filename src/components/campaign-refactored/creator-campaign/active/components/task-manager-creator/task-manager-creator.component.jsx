    ...
    <div className="flex flex-col">
      ...
      <div className="mb-3">
        ...
        <p className="mt-0.5 text-[10px] text-gray-500 sm:text-xs">
          Actions needed across all collaborations
        </p>
      </div>
        ...
        {isInitialLoad && getCreatorTasksState.isLoading ? (
          ...
          tasks.map((task) => {
            ...
            return (
              <div
                key={task.id}
                className={`rounded-lg border bg-gray-50 p-2.5 transition-all hover:shadow-sm sm:p-3 ${
                  isOverdue
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="mb-1 text-sm font-semibold text-gray-900">{formatName(task)}</h4>
