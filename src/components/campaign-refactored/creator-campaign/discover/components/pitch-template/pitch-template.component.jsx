  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col border-x bg-white p-3 sm:p-4">
      <div className="flex justify-between items-center mb-3 sm:mb-4 gap-2">
        ...
        <button
          type="button"
          className="bg-gray-200 p-1.5 sm:p-2 rounded-full shrink-0"
          onClick={handleOpenNewPitchForm}
        >
      ...
      <div className="mb-6 flex-1 min-h-0 space-y-3 overflow-y-auto">
        {pitchTemplates.length > 0 ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 text-xs sm:text-sm">No pitch templates yet</p>
            <p className="text-gray-400 text-[10px] sm:text-xs">
              Create your first pitch template to get started
            </p>
          </div>
        )}
      </div>
