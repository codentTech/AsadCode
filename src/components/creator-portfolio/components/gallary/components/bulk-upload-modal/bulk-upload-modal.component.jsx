      ...
      <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            ...
            {FILE_TYPES.map((type) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center justify-center gap-2 rounded-lg border-2 px-2.5 py-2 text-xs font-medium transition-all sm:px-4 sm:text-sm ${
        ...
        <div className="flex flex-col gap-[6px] text-xs font-medium capitalize not-italic leading-6 text-text-black">
          ...
          <button
            ...
            className="group w-full rounded-lg border-2 border-dashed border-gray-300 p-4 text-center transition-all hover:border-indigo-400 hover:bg-indigo-50 disabled:cursor-not-allowed disabled:opacity-50 sm:p-6"
          >
