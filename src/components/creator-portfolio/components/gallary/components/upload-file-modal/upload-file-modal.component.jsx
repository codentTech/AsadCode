      ...
      <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
        ...
        <div className="flex flex-col gap-[6px] text-xs font-medium capitalize not-italic leading-6 text-text-black">
          ...
          <button
            ...
            className="group w-full rounded-lg border-2 border-dashed border-gray-300 p-4 text-center transition-all hover:border-indigo-400 hover:bg-indigo-50 sm:p-6"
          >
            {selectedFile ? (
