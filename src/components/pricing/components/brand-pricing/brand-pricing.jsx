...
export default function BrandPricing() {
  const brandData = [
    ...
    },
    {
      ...
      contract: "Yes",
      details:
        "12-month minimum commitment; focuses on affiliate and influencer management.",
    },
    {
      platform: "Traackr",
      price: "From $2,500",
      ...
      <table className="min-w-full">
        ...
        <tbody>
          {brandData.map((platform, index) => (
            ...
            >
              <td className="py-4 px-6 text-left border-b border-indigo-100">
              ...
              <td
                className={`py-4 px-6 text-left border-b border-indigo-100 ${
