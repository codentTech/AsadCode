...
export default function CreatorPricing() {
  const creatorData = [
    ...
    },
    {
      ...
      details:
        "Charges brands ~$100–$150 per video, creators report payouts far lower.",
    },
    {
      platform: "Billo",
      commission: "Likely ~30–40% margin",
      details:
        "Known for large spread between what brands pay and what creators earn.",
    },
    {
      platform: "Creator.co",
      commission: "Not disclosed; likely backend margin",
      details:
        "Commission not disclosed; may build margin into creator payouts.",
    },
    {
      platform: "Social Cat",
      commission: "Not disclosed; may take margin",
      details:
        "Commission not disclosed; may build margin into creator pricing.",
    },
  ];
      ...
      <table className="min-w-full">
        <thead>
          <tr className="bg-indigo-50">
            <th className="py-6 px-6 text-left text-lg font-semibold text-indigo-900 border-b border-indigo-100">
              Platform
            </th>
            <th className="py-6 px-6 text-left text-lg font-semibold text-indigo-900 border-b border-indigo-100">
              Creator Commission
        ...
        <tbody>
          {creatorData.map((platform, index) => (
            ...
            >
              <td className="py-4 px-10 text-left border-b border-indigo-100">
              ...
              <td
                className={`py-4 px-6 text-left border-b border-indigo-100 ${platform.isBest ? "font-bold text-indigo-800" : "text-gray-600"}`}
              >
                {platform.commission}
              </td>
