  ...
  return (
    <div className="w-[27%] bg-white flex flex-col border-l h-screen">
      ...
      {!selectedCampaign && (
        <div className="flex flex-col items-center justify-center py-16 text-center px-4">
          ...
          <p className="text-gray-500 max-w-xs">
            {isCompleted
              ? "Select a completed campaign to view deliverables, timeline, and reviews."
              : "Select an active campaign to manage deliverables and track progress."}
          </p>
        </div>
      )}
      ...
      {selectedCampaign && !selectedCreator && (
        <div className="flex flex-col items-center justify-center py-16 text-center px-4">
          <CheckCircle2 className="w-16 h-16 text-gray-400 mb-4" />
          <h3 className="text-xl font-medium text-gray-900 mb-2">Select a Creator</h3>
          <p className="text-gray-500 max-w-xs">
            Choose a creator from the middle panel to view their details, deliverables, and
            progress.
          </p>
        </div>
      )}
          ...
          <div className="flex flex-col items-center pt-3 pb-4 px-4 border-b sticky gap-2 top-0 bg-white z-10">
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-500 ml-1">
                ({selectedCreator.reviewCount || 0} reviews)
              </span>
            </div>
                  ...
                  {isCompleted ? (
                    ...
                    <>
                      ...
                      <div className="flex flex-col 2xl:flex-row gap-3">
                        ...
                        <CustomButton text="Send Message" className="btn-outline w-full" />
                      </div>
                    </>
                  )}
                </div>
