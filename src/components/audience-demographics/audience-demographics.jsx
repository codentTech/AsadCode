...
function AudienceDemographics({ className = "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3" }) {
  const { colors, genderData, ageData, locationData } = useAudienceDemographics();
